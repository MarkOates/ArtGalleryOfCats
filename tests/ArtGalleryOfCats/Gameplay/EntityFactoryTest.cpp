...
TEST_F(ArtGalleryOfCats_Gameplay_EntityFactoryTestWithAllegroRenderingFixture,
   create_sculpture_art__will_create_an_art_with_the_expected_properties)
{
   ...
   ArtGalleryOfCats::Gameplay::Entities::Base *created_object = entity_factory.create_sculpture_art(
      "foobar_art",
      "art-01.obj",
      "art-01.png",
      { 14, 0, 12 },
