...
class ArtGalleryOfCats_Screens_UserTextInputTest : public ::testing::Test {};
class ArtGalleryOfCats_Screens_UserTextInputTestWithAllegroRenderingFixture
...
TEST_F(ArtGalleryOfCats_Screens_UserTextInputTest, can_be_created_without_blowing_up)
{
   ArtGalleryOfCats::Screens::UserTextInput character_name_input;
}


TEST_F(ArtGalleryOfCats_Screens_UserTextInputTest, render__before_initialized__raises_an_error)
{
   ArtGalleryOfCats::Screens::UserTextInput character_name_input;
   std::string expected_error_message =
      "UserTextInput::render: error: guard \"initialized\" not met";
   EXPECT_THROW_WITH_MESSAGE(character_name_input.render(), std::runtime_error, expected_error_message);
}


TEST_F(ArtGalleryOfCats_Screens_UserTextInputTestWithAllegroRenderingFixture,
   initialize__will_not_blow_up)
{
   AllegroFlare::EventEmitter event_emitter;
   event_emitter.initialize();
   ArtGalleryOfCats::Screens::UserTextInput character_name_input(&event_emitter, &get_font_bin_ref());
   ...
   DISABLED__INTERACTIVE__will_work_as_expected)
{
   ...
   ArtGalleryOfCats::Screens::UserTextInput character_name_input_screen;
