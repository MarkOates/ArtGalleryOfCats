...
namespace ArtGalleryOfCats
{
   namespace Gameplay
   {
      ...
      public:
         LevelFactory(AllegroFlare::BitmapBin* bitmap_bin=nullptr, AllegroFlare::ModelBin* model_bin=nullptr, AllegroFlare::SceneGraph::EntityPool* entity_pool={}, ArtGalleryOfCats::Gameplay::Riddle* riddle=nullptr, ArtGalleryOfCats::Gameplay::Level* level=nullptr);
         ~LevelFactory();
