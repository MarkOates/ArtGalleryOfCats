...
ALLEGRO_FONT* Bubble::obtain_dialog_font()
{
   if (!(al_is_font_addon_initialized()))
   {
      ...
      error_message << "[ArtGalleryOfCats::Elements::DialogBoxRenderers::Bubble::obtain_dialog_font]: error: guard \"al_is_font_addon_initialized()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[ArtGalleryOfCats::Elements::DialogBoxRenderers::Bubble::obtain_dialog_font]: error: guard \"al_is_font_addon_initialized()\" not met");
   }
   if (!(al_is_ttf_addon_initialized()))
   {
      std::stringstream error_message;
      error_message << "[ArtGalleryOfCats::Elements::DialogBoxRenderers::Bubble::obtain_dialog_font]: error: guard \"al_is_ttf_addon_initialized()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[ArtGalleryOfCats::Elements::DialogBoxRenderers::Bubble::obtain_dialog_font]: error: guard \"al_is_ttf_addon_initialized()\" not met");
   }
   if (!(font_bin))
   {
      std::stringstream error_message;
      error_message << "[ArtGalleryOfCats::Elements::DialogBoxRenderers::Bubble::obtain_dialog_font]: error: guard \"font_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[ArtGalleryOfCats::Elements::DialogBoxRenderers::Bubble::obtain_dialog_font]: error: guard \"font_bin\" not met");
   }
